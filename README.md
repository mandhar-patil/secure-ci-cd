...
2. Create ECR Private Repository: 
    ...
    *   **Repository name**: `secure-ci-cd`.
    *   Click **Create repository**.
3.  **Go to AWS App Runner**: Open the [AWS App Runner Console](https://console.aws.amazon.com/apprunner).
4.  **Create Service**:
...
5.  **Configure Service**:
    ...
    *   **Port**: `3000`.
6.  **Create & Deploy**: Click create.
7.  **Get the URL**: Once deployed, copy the "Default domain" URL.
